...
public class ListUsersResponse
{
    ...
    /// </summary>
    public ListUsersNameResponse Name { get; set; } = null!;

    /// <summary>
    /// The user's address details
    /// </summary>
    public ListUsersAddressResponse Address { get; set; } = null!;
}
...
public class ListUsersAddressResponse
{
    ...
    /// </summary>
    public ListUsersGeoLocationResponse GeoLocation { get; set; } = null!;
}
