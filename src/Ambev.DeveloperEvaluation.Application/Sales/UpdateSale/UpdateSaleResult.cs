...
/// Contains details about the sale, such as its identifier, associated user and branch, items, and timestamps.
...
public class UpdateSaleResult
{
    ...
    /// </summary>
    public List<UpdateSaleItemResult> Items { get; set; } = null!;
...
/// <summary>
/// Represents the result of updating an item within a sale.
/// Tracks details such as pricing, discounts, and quantity.
/// </summary>
