...
public static class UpdateProductHandlerTestData
{
    ...
    /// </summary>
    private static readonly Faker<UpdateProductCommand> createUpdateCommandFaker = new Faker<UpdateProductCommand>()
        ...
        .RuleFor(u => u.Rating, f => new UpdateRatingCommand
        {
    ...
    {
        return createUpdateCommandFaker.Generate();
    }
}
